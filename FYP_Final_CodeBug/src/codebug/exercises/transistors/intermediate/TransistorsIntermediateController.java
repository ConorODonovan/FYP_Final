...
Final Year Project
CodeBug
TransistorsIntermediateController - Controls logic for Transistors Intermediate Exercise
 */

package codebug.exercises.transistors.intermediate;
...
public class TransistorsIntermediateController {
    ...
    public void checkAnswer1() {
        if (answer1.getValue() == answer1.getItems().get(0)) {
        ...
        if (result1.getText().equals("Correct!") && result2.getText().equals("Correct!") && result3.getText().equals("Correct!")) {
            DBUtils.updateTransistorsIntermediate();
        }
    }
