...
public class DraggableNode extends AnchorPane {
		...
		// NEW CODE
		private Image transistorOn = new Image(getClass().getResourceAsStream("/codebug/exercises/transistors/logicgateicons/Transistor_ON.png"));
		private Image transistorOff = new Image(getClass().getResourceAsStream("/codebug/exercises/transistors/logicgateicons/Transistor_OFF.png"));
		@FXML
		private ImageView image = new ImageView(transistorOn);
		...
		private void initialize() {
			...
			// NEW CODE
//			root_pane.getChildren().add(image);
