...
Final Year Project
CodeBug
CipherIntermediateController - Controls logic for Cipher Intermediate Exercise
 */

package codebug.exercises.ciphers.intermediate;
...
public class CipherIntermediateController {
    ...
    public void question1() {
        ...
        System.out.println(VigenereCipher.decrypt(answer, "ENIGMA"));
        System.out.println(VigenereCipher.encrypt(textFieldAnswer1.getText().toUpperCase(), "ENIGMA"));

        if (textFieldAnswer1.getText().equals(VigenereCipher.decrypt(answer.toUpperCase(), "ENIGMA"))) {
        ...
        if (result1.getText().equals("Correct!") && result2.getText().equals("Correct!") && result3.getText().equals("Correct!")) {
            DBUtils.updateCiphersIntermediate();
        }
    }
    ...
    public void question2() {
        ...
        System.out.println(answer);
        System.out.println(VigenereCipher.decrypt(textFieldAnswer2.getText().toUpperCase(), "STARDUST"));

        if (textFieldAnswer2.getText().equals(VigenereCipher.decrypt(answer.toUpperCase(), "STARDUST"))) {
    ...
    public void question3() {
        String answer = (labelQuestion3a.getText().toUpperCase() + " " + labelQuestion3b.getText().toUpperCase() + " " + labelQuestion3c.getText().toUpperCase() + " " + labelQuestion3d.getText().toUpperCase());
